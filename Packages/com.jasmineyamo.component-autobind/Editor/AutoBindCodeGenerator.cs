...
namespace JasmineYamo.ComponentAutoBind.Editor
{
    internal static class AutoBindCodeGenerator
    {
        ...
        private static string BuildCode(ComponentAutoBindTool target, string className)
        {
            ...
            bool hidesInheritedUIView = HasVisibleInheritedNestedType(
                targetScriptType,
                "UIView");
            bool hidesInheritedViewField = HasVisibleInheritedField(
                targetScriptType,
                "view");
            ...
            builder.Append(classIndent)
                ...
                .Append(className)
                .Append(" : global::")
                .Append(typeof(IAutoBindHost).FullName);
            builder.AppendLine();
            builder.Append(classIndent).AppendLine("{");
            builder.Append(memberIndent).AppendLine("[Serializable]");
            builder.Append(memberIndent)
                .Append(hidesInheritedUIView
                    ? "public new class UIView : global::"
                    : "public class UIView : global::")
                .AppendLine(typeof(IUiViewComponent).FullName);
            ...
            builder.AppendLine();
            builder.Append(memberIndent)
                .AppendLine(hidesInheritedViewField
        ...
        private static bool HasVisibleInheritedNestedType(
            ...
            string nestedTypeName)
        {
            for (Type currentType = targetScriptType?.BaseType;
                ...
                currentType = currentType.BaseType)
            {
                Type nestedType = currentType.GetNestedType(
                    nestedTypeName,
                    BindingFlags.Public | BindingFlags.NonPublic);
                if (nestedType != null && !nestedType.IsNestedPrivate)
                {
                    return true;
                }
            }
        ...
        private static bool HasVisibleInheritedField(
            Type targetScriptType,
            string fieldName)
        {
            for (Type currentType = targetScriptType?.BaseType;
