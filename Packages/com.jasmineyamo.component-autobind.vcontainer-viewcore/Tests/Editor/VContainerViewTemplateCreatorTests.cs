...
using ViewCoreEditor = JasmineYamo.ComponentAutoBind.ViewCore.Editor;
...
namespace JasmineYamo.ComponentAutoBind.ViewCore.Tests
{
    public sealed class VContainerViewTemplateCreatorTests
    {
        private const string ViewTemplatePath =
            "Packages/com.jasmineyamo.component-autobind.vcontainer-viewcore/"
        ...
        public void MenuUsesTopLevelPathAndExpectedPriority()
        {
            MethodInfo createMethod = typeof(
                    ViewCoreEditor.VContainerViewTemplateCreator)
                .GetMethod(
        ...
        public void MenuAppearsAboveCSharpScript()
        {
            ...
            int viewIndex = Array.IndexOf(
                menuPaths,
                ViewCoreEditor.VContainerViewTemplateCreator.MenuPath);
        ...
        {
            bool success = ViewCoreEditor.VContainerViewTemplateCreator.TryBuildNames(
                requestedName,
                out ViewCoreEditor.VContainerViewTemplateNames names,
                out string error);
        ...
        {
            bool success = ViewCoreEditor.VContainerViewTemplateCreator.TryBuildNames(
                ViewCoreEditor.VContainerViewCreateWindow.DefaultName,
                out ViewCoreEditor.VContainerViewTemplateNames names,
                out string error);
        ...
        {
            bool success =
                ViewCoreEditor.VContainerViewTemplateCreator.TryGetActiveFolderPath(
        ...
        {
            var names = new ViewCoreEditor.VContainerViewTemplateNames(
                "AutoBindTestView",
                "AutoBindTestPresenter");

            string viewCode = ViewCoreEditor.VContainerViewTemplateCreator.RenderTemplate(
                LoadTemplate(ViewTemplatePath),
                names,
                string.Empty);
            string presenterCode = ViewCoreEditor.VContainerViewTemplateCreator.RenderTemplate(
        ...
        public void TemplatesRenderInsideConfiguredNamespace()
        {
            ...
            StringAssert.Contains(
                ...
                viewCode);
            Assert.That(
                ViewCoreEditor.VContainerViewTemplateCreator.IsValidNamespace("Example.Views"),
                Is.True);
            Assert.That(
                ViewCoreEditor.VContainerViewTemplateCreator.IsValidNamespace("Example..Views"),
                Is.False);
        ...
        public void DirectWriteCreatesExactlyTwoUtf8Scripts()
        {
            ...
            try
            {
                ...
                bool success =
                    ViewCoreEditor.VContainerViewTemplateCreator.TryWriteScriptsDirectly(
                        viewPath,
